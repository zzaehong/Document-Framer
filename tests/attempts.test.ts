...
const value = { domains: [{ path: ['Other'], source: 'unclassified', confidence: 0.1 }], contentNature: { id: 'opinion', confidence: 0.5 }, concepts: [{ concept: 'Reusable concept', confidence: 0.7 }] };
